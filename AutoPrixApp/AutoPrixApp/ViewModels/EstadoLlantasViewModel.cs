    ...
    public class EstadoLlantasViewModel : BaseViewModel
    {
        ...
        private List<OrdenTrabajoLlantas> validarCampos()
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Campo invalido Presión 1");
                }
                ...
                {
                    throw new Exception("Campo invalido Presión 2");
                }
                ...
                {
                    throw new Exception("Campo invalido Presión 3");
                }
                ...
                {
                    throw new Exception("Campo invalido Presión 4");
                }
